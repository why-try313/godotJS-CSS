export default {
	...
	"min-width": [ "margin_left", "margin_right", "anchor_left", "anchor_right" ],
	"min-height": [ "margin_top", "margin_bottom", "anchor_top", "anchor_bottom" ],
	"max-width": [ "margin_left", "margin_right", "anchor_left", "anchor_right" ],
	"max-height": [ "margin_top", "margin_bottom", "anchor_top", "anchor_bottom" ],
